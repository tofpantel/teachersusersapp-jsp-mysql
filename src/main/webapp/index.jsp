...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/teachersusersapp/static/css/index.css">
</head>
<body>
<div class="container-fluid">
    <div class="header">
        <div class="logo">
            <img src="${pageContext.request.contextPath}/teachersusersapp/static/img/aueb100b.png" alt="AUEB 100 years">
        </div>
        <div class="menu">
            <ul>
                <li><a href="#">Home</a></li>
