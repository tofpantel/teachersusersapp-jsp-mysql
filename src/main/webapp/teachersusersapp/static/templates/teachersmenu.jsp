...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/teachersusersapp/static/css/teachersmenu.css">
</head>
<body>
  <div class="center">
  ...
  <div class="center">
    <div class="search-wrapper">
      ...
      <div class="bot-gap">
        <form method="POST" action="${pageContext.request.contextPath}/teachersusersapp/search">
